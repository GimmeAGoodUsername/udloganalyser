...
import { useAuth } from '../delete/context/AuthContext'
...
function Navbar() {
    ...
    return (
        <Menu inverted color='blue' stackable size='massive' style={{ borderRadius: 0 }}>
            <Container>
                <Menu.Item header>SR APP</Menu.Item>
                <Menu.Item as={Link} exact='true' to="/">Bestellungen</Menu.Item>
                <Menu.Item as={Link} exact='true' to="/user">User</Menu.Item>

                <Menu.Item as={Link} to="/user" style={userPageStyle()}>UserPage</Menu.Item>
